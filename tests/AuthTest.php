...
// Ruta adaptada al contenedor docker apache-php con rutas absolutas dentro del contenedor (modificado por __DIR__)
// __DIR__ concatena la ruta para incluir la /
// De esta forma __DIR__ apunta siempre al directorio actual del fichero tests y sube un nivel hasta TaskFlow
