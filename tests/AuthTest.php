...
// Ruta adaptada al contenedor docker apache-php con rutas absolutas dentro del contenedor
require_once '/var/www/TaskFlow/app/data.php';
require_once '/var/www/TaskFlow/app/controllers/AuthController.php';
